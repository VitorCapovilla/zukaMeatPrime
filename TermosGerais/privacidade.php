...
<main class="">
        <div class="container">
            ...
            <p>A sua privacidade é importante para nós. É política do MeatPrime respeitar a sua privacidade em relação a
                qualquer informação sua que possamos coletar no site <a href=http://www.dominio.com>MeatPrime</a>, e
            ...
            <h2>Política de Cookies MeatPrime</h2>
            ...
            <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o MeatPrime oferece no
                site e com caráter enunciativo, mas não limitativo:</p>
            <ul>
                <li>A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</li>
                <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou apostas desportivas
                    (ex.:<a href='https://ondeapostar.pt/review/moosh-portugal/'> Moosh</a>), jogos de sorte e azar,
                    qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
                <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do MeatPrime, de seus
