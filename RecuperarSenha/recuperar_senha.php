...
<body>
    ...
    if (!empty($dados['SendRecupSenha'])) {
        //var_dump($dados);
        $query_usuario = "SELECT codigo, nome, sobrenome, datanascimento, cpf, telefone, email, senha 
                    FROM cliente 
                    WHERE email =:usuario  
                    LIMIT 1";
    ...
    <form method="POST" action="">
        ...
        <label>E-mail</label>
        <input type="text" name="usuario" placeholder="Digite o usuário" value=""><br><br>

        <input type="submit" value="Recuperar" name="SendRecupSenha">
    </form>

    <br>
    voltar <a href="index.php">clique aqui</a> para logar
