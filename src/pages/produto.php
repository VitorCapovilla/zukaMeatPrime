<?php 
    ...
    $lstCategorias = $CategoriaDAO->obter_todos();

    if(isset($_GET["codigo"])){
        $ProdutoDTO = $ProdutoDAO->obter($_GET["codigo"]);
    }
?>
                ...
                <form action="NovoProduto.php" method="POST">
                    <div class="card mb-3 bg-secondary">
                        ...
                        <div class="card-body bg-dark">
                            ...
                            <div class="form-group">
                                <label for="TituloCategoria"><span class="text-light InfoCampo"> Categoria:</span></label>
                                <select class="form-control" id="TituloCategoria" name="TituloCategoria">
                                    <?php
                                        ...
                                        foreach($lstCategorias as $objCategoria){ 
                                            ...
                                            if ($objCategoria->get_codigo() == $ProdutoDTO->get_categoria()->get_codigo()) echo "selected";
                                            echo ">" . $objCategoria->get_titulo() . "</option>";
                                        }
